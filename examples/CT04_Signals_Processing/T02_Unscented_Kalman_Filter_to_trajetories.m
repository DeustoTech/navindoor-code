...
% del estado.
UKF = unscentedKalmanFilter(@CT04S01_StateTransition,@CT04S01_Measurement,initialStateGuess)
%% 
% *Covarianzas del de las  medidas y del modelo*
% 
sigma_m = 2.0;  % desviacion estandar de medicion de attenuacion
sigma_d = 1.0;  % desviacion estandar del modelo
%%
% Agregamos estas desviaciones, creaando una matriz de covariancias
dt = iBBSL_RSS.dt;
total_beacon = length(iBBSL_RSS.beacons);
UKF.MeasurementNoise = diag(repmat(sigma_m^2,1,total_beacon));
UKF.MeasurementNoise
%%
%             
UKF.ProcessNoise = diag([(dt^4)/4 , dt^4/4  , dt^2  ,  dt^2]*sigma_d^2);
UKF.ProcessNoise
%% 
% *Método de ejecución*
%%
