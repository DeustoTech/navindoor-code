...
%   Detailed explanation goes here
    ...
    panel_graphs     = uipanel(tab_trajectory,'Title','Graphs'   ,'Position',[0.04   0.0   0.81  0.82 ],'Tag','Graphs');
    CT02_panel_graphs(h,panel_graphs);
    
    panel_info_objects = uipanel(tab_trajectory,'Title','Info Objects','Position',[0.85   0.64   0.15  0.18 ],'Tag','Info Objects');
    CT02_panel_info_objects(h,panel_info_objects);

    panel_supertrajs = uipanel(tab_trajectory,'Title','Supertraj'    ,'Position',[0.85   0.0   0.15  0.64 ],'Tag','Supertraj');
