...
%             if y<=wall1.intervals.ymax && ...
%                y>=wall1.intervals.ymin && ...
%                x<=wall1.intervals.xmax && ...
%                x>=wall1.intervals.xmin && ...
%                y<=wall2.intervals.ymax && ...
%                y>=wall2.intervals.ymin && ...
%                x<=wall2.intervals.xmax && ...
%                x>=wall2.intervals.xmin
%                boolean = true;
%             else
%                r = [];
%                boolean = false;
