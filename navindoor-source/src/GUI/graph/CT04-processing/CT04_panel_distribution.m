...
%   Detailed explanation goes here
    ...
    %% Algoritms
    panel_control           = uipanel(tab_processing,'Title','Algorithms'  ,'Position',[0.125   0.78   0.4  0.22 ],'Tag','Control');
    CT04_panel_control(h,panel_control);

    %% Signals Available
    panel_signal_aviable    = uipanel(tab_processing,'Title','Signals'   ,'Position',[0.525   0.78   0.2  0.22 ],'Tag','Signals Available');
    CT04_panel_signal_aviable(h,panel_signal_aviable);
  
    %% Estimators 
    panel_straj_estimation  = uipanel(tab_processing,'Title','Estimations','Position',    [0.725   0.78   0.275  0.22 ],'Tag','Estimators');
