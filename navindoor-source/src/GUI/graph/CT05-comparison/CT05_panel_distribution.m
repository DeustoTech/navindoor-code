...
%   Detailed explanation goes here
    ...
    %%
    panel_supertrajs = uipanel(tab_processing,'Title','Trajectory'    ,'Position',[0.85   0.6   0.15  0.4 ],'Tag','Supertraj');
    CT05_panel_supertrajs(h,panel_supertrajs);
    %%
    panel_Estimator_aviable = uipanel(tab_processing,'Title','Estimators Available'   ,'Position',[0.85   0.2   0.15  0.4 ],'Tag','Estimators Available');

    %%

    panel_compare  = uipanel(tab_processing,'Title','Compare'    ,'Position',[0.85   0.0   0.15  0.2 ],'Tag','Compares');
