...
%   Detailed explanation goes here
    ...
    if isnan(input_hight)
        ...
        object.String = num2str(h.planimetry_layer(index_level).height);
        return
    end
    ...
    if index_level > 1
        ...
        boolean_list = [h.planimetry_layer(1:index_level-1).height] > input_hight;
    ...
    h.planimetry_layer(index_level).height = input_hight;
